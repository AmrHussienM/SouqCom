...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void userInfoSaved()
    {
        ...
        {
            Toast.makeText(this, "Phone is missing..", Toast.LENGTH_SHORT).show();
        }
    ...
    private void userInfoDisplay(final CircleImageView profileImageView, final EditText fullName, final EditText userPhone, EditText userAddress)
    {
    ...
    private void identification()
    {
        ...
        userPhone=findViewById(R.id.settings_phone_number);
        userAddress=findViewById(R.id.settings_address);
        profileChange=findViewById(R.id.profile_image_change_btn);
        closeBtn=findViewById(R.id.close_setting_btn);
        saveBtn=findViewById(R.id.update_account_settings);
    }
}
